    ...
    >
      <div className="mr-1 flex whitespace-nowrap">
        {state === "open" ? (
          ...
          <div className="mr-2 self-start rounded-[2em] bg-[#8250df] px-3 py-[5px] text-center text-[14px] font-medium leading-5 text-[#fff]">
            <IssueClosedIcon size={16} />
            <span className="ml-1">{state}</span>
          </div>
        ) : (
          <div className="mr-2 self-start rounded-[2em] bg-[#6e7781] px-3 py-[5px] text-center text-[14px] font-medium leading-5 text-[#fff]">
            <SkipIcon size={16} />
            <span className="ml-1">{state}</span>
          </div>
        )}
